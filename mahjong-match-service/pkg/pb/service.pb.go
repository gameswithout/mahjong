...
const file_service_proto_rawDesc = "" +
	...
	"\aaccount\x18\x01 \x01(\v2\x14.service.JadeAccountR\aaccount\"n\n" +
	...
	"%MATCH_COMMAND_TYPE_DECLARE_ADDED_KONG\x10\x062\x9b\x0f\n" +
	...
	"\n" +
	"\n" +
	"\x06Bearer\x12\x00\x82\xd3\xe4\x93\x02-*+/v1/namespaces/{namespace}/jade/reservation\x12\xcb\x02\n" +
...
var file_service_proto_goTypes = []any{
	...
	(*GetMatchStateRequest)(nil),       // 9: service.GetMatchStateRequest
	(*GetMatchStateResponse)(nil),      // 10: service.GetMatchStateResponse
	(*SubmitMatchCommandRequest)(nil),  // 11: service.SubmitMatchCommandRequest
	(*ClaimCommand)(nil),               // 12: service.ClaimCommand
	(*SubmitMatchCommandResponse)(nil), // 13: service.SubmitMatchCommandResponse
	(*MatchState)(nil),                 // 14: service.MatchState
	(*TileIDSet)(nil),                  // 15: service.TileIDSet
	(*SelfTurnOptions)(nil),            // 16: service.SelfTurnOptions
	(*JadeAccount)(nil),                // 17: service.JadeAccount
	(*JadeReservation)(nil),            // 18: service.JadeReservation
	(*JadeSettlement)(nil),             // 19: service.JadeSettlement
	(*Tile)(nil),                       // 20: service.Tile
	(*PlayerView)(nil),                 // 21: service.PlayerView
	(*Meld)(nil),                       // 22: service.Meld
	(*MeldView)(nil),                   // 23: service.MeldView
	(*WaitTileView)(nil),               // 24: service.WaitTileView
	(*WallView)(nil),                   // 25: service.WallView
	(*Discard)(nil),                    // 26: service.Discard
	(*ClaimView)(nil),                  // 27: service.ClaimView
	(*ClaimResponse)(nil),              // 28: service.ClaimResponse
	(*ChowSet)(nil),                    // 29: service.ChowSet
	(*ClaimOptionsView)(nil),           // 30: service.ClaimOptionsView
	(*ScoreContext)(nil),               // 31: service.ScoreContext
	(*PatternScore)(nil),               // 32: service.PatternScore
	(*HandShape)(nil),                  // 33: service.HandShape
	(*ScoreResult)(nil),                // 34: service.ScoreResult
	(*HandWinner)(nil),                 // 35: service.HandWinner
	(*HandResult)(nil),                 // 36: service.HandResult
	(*Transfer)(nil),                   // 37: service.Transfer
	(*Settlement)(nil),                 // 38: service.Settlement
	(*ContinuationOutcome)(nil),        // 39: service.ContinuationOutcome
	nil,                                // 40: service.Settlement.NetEntry
}
var file_service_proto_depIdxs = []int32{
	14, // 0: service.JoinMatchResponse.state:type_name -> service.MatchState
	17, // 1: service.GetJadeAccountResponse.account:type_name -> service.JadeAccount
	17, // 2: service.ReserveJadeResponse.account:type_name -> service.JadeAccount
	18, // 3: service.ReserveJadeResponse.reservation:type_name -> service.JadeReservation
	17, // 4: service.ReleaseJadeResponse.account:type_name -> service.JadeAccount
	14, // 5: service.GetMatchStateResponse.state:type_name -> service.MatchState
	0,  // 6: service.SubmitMatchCommandRequest.type:type_name -> service.MatchCommandType
	12, // 7: service.SubmitMatchCommandRequest.claim:type_name -> service.ClaimCommand
	14, // 8: service.SubmitMatchCommandResponse.state:type_name -> service.MatchState
	20, // 9: service.MatchState.own_hand:type_name -> service.Tile
	20, // 10: service.MatchState.own_exposed:type_name -> service.Tile
	21, // 11: service.MatchState.players:type_name -> service.PlayerView
	25, // 12: service.MatchState.wall:type_name -> service.WallView
	26, // 13: service.MatchState.last_discard:type_name -> service.Discard
	27, // 14: service.MatchState.claim:type_name -> service.ClaimView
	24, // 15: service.MatchState.waits:type_name -> service.WaitTileView
	22, // 16: service.MatchState.own_melds:type_name -> service.Meld
	26, // 17: service.MatchState.discards:type_name -> service.Discard
	36, // 18: service.MatchState.hand_result:type_name -> service.HandResult
	38, // 19: service.MatchState.settlement:type_name -> service.Settlement
	39, // 20: service.MatchState.next_dealer:type_name -> service.ContinuationOutcome
	17, // 21: service.MatchState.jade_account:type_name -> service.JadeAccount
	19, // 22: service.MatchState.jade_settlement:type_name -> service.JadeSettlement
	16, // 23: service.MatchState.self_turn_options:type_name -> service.SelfTurnOptions
	34, // 24: service.SelfTurnOptions.win_preview:type_name -> service.ScoreResult
	15, // 25: service.SelfTurnOptions.concealed_kongs:type_name -> service.TileIDSet
	20, // 26: service.PlayerView.exposed:type_name -> service.Tile
	23, // 27: service.PlayerView.melds:type_name -> service.MeldView
	20, // 28: service.Meld.tiles:type_name -> service.Tile
	20, // 29: service.MeldView.tiles:type_name -> service.Tile
	20, // 30: service.WaitTileView.tile:type_name -> service.Tile
	20, // 31: service.Discard.tile:type_name -> service.Tile
	26, // 32: service.ClaimView.discard:type_name -> service.Discard
	28, // 33: service.ClaimView.own_response:type_name -> service.ClaimResponse
	30, // 34: service.ClaimView.options:type_name -> service.ClaimOptionsView
	29, // 35: service.ClaimOptionsView.chow_sets:type_name -> service.ChowSet
	34, // 36: service.ClaimOptionsView.win_preview:type_name -> service.ScoreResult
	20, // 37: service.HandShape.pair:type_name -> service.Tile
	22, // 38: service.HandShape.melds:type_name -> service.Meld
	32, // 39: service.ScoreResult.patterns:type_name -> service.PatternScore
	33, // 40: service.ScoreResult.shape:type_name -> service.HandShape
	31, // 41: service.HandWinner.context:type_name -> service.ScoreContext
	34, // 42: service.HandWinner.score:type_name -> service.ScoreResult
	35, // 43: service.HandResult.winners:type_name -> service.HandWinner
	37, // 44: service.Settlement.transfers:type_name -> service.Transfer
	40, // 45: service.Settlement.net:type_name -> service.Settlement.NetEntry
	3,  // 46: service.Service.GetJadeAccount:input_type -> service.GetJadeAccountRequest
	5,  // 47: service.Service.ReserveJade:input_type -> service.ReserveJadeRequest
	7,  // 48: service.Service.ReleaseJade:input_type -> service.ReleaseJadeRequest
	1,  // 49: service.Service.JoinMatch:input_type -> service.JoinMatchRequest
	9,  // 50: service.Service.GetMatchState:input_type -> service.GetMatchStateRequest
	11, // 51: service.Service.SubmitMatchCommand:input_type -> service.SubmitMatchCommandRequest
	4,  // 52: service.Service.GetJadeAccount:output_type -> service.GetJadeAccountResponse
	6,  // 53: service.Service.ReserveJade:output_type -> service.ReserveJadeResponse
	8,  // 54: service.Service.ReleaseJade:output_type -> service.ReleaseJadeResponse
	2,  // 55: service.Service.JoinMatch:output_type -> service.JoinMatchResponse
	10, // 56: service.Service.GetMatchState:output_type -> service.GetMatchStateResponse
	13, // 57: service.Service.SubmitMatchCommand:output_type -> service.SubmitMatchCommandResponse
