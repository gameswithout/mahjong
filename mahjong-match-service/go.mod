module github.com/gameswithout/mahjong/mahjong-match-service

go 1.24.0

require (
	github.com/AccelByte/accelbyte-go-sdk v0.87.1
	github.com/gameswithout/mahjong v0.0.0
...
// The parent module is the canonical home of the shared rules engine during
// local development. Replace this with a tagged module version before the
// standalone Extend image is built in CI.
